...
impl Iterator for BaseHopping {
    ...
    fn next(&mut self) -> Option<Self::Item> {
        ...
        let base_val: String = format!("{:o}", current);
...
fn hello() {
    ...
    */
    ...
    let arr: Vec<u64> = vec![8, 10, 12, 14, 16, 20, 24, 30, 36, 44, 54, 66, 102, 146, 222, 336, 520, 1010, 1762, 3342, 6416, 14420, 34124, 102514, 310162, 1135622, 4252006, 20160546, 114720042, 665476452, 4752456544, 43321135540, 502611010664, 7240574662150, 151272370273006, 4231232771175356, 170204424622331674, 11345400267464053432];
    ...
    let base: BaseHopping;
    base = BaseHopping { curr_val: 8 };
